...
export const RuggedFaucet = () => {
  ...
  const Rugged = useMemo(() => {
    return DeFiat && DeFiat.web3 && new DeFiat.web3.eth.Contract(IShitcoin as AbiItem[], Addresses.RUG[chainId])
  }, [DeFiat, chainId])

  const Shitcoin = useMemo(() => {
    return DeFiat && DeFiat.web3 && new DeFiat.web3.eth.Contract(IShitcoin as AbiItem[], Addresses.SHIT[chainId])
  }, [DeFiat, chainId]) 
